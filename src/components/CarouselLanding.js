...
const tutorialSteps = [
  ...
  {
    label:
      "Califica a tu mentor, así ayudarás a que mejore y a que otros usuarios tengan una mejor experiencia",
    imgPath:
  ...
  {
    label:
      "Conviértete en un mentor y también comparte tu conocimiento con los demás",
    imgPath:
